...
export const requireReadContacts   = requiredScopes('read:contacts');
export const requireCreateContacts = requiredScopes('create:contacts');
export const requireUpdateContacts = requiredScopes('update:contacts');
export const requireDeleteContacts = requiredScopes('delete:contacts');
