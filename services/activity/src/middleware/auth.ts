...
export const requireReadActivities   = requiredScopes('read:activities');
export const requireCreateActivities = requiredScopes('create:activities');
export const requireUpdateActivities = requiredScopes('update:activities');
export const requireDeleteActivities = requiredScopes('delete:activities');
